      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-6">
        <section className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Live status for the API backing Search Hub across tenants and workloads.
          </p>
        </section>
        ...
        <section className="grid gap-4 md:grid-cols-[2fr_1fr]">
          <Card className="flex flex-col">
            <CardHeader className="flex flex-row items-center justify-between space-y-0">
              <div>
                ...
                <CardDescription>HTTP response from the operational endpoint</CardDescription>
              </div>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              {isHealthy ? (
                <p>The connection succeeded and returned a healthy payload.</p>
              ) : (
                <p>
                  The service is reporting issues. Check logs and ensure the worker is
                  reachable.
                </p>
              )}
            </CardContent>
