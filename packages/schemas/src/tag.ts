...
// ============================================================================
// Error Result Types (for service layer)
// ============================================================================

/**
 * Create tag result
 */
export type CreateTagResultType =
    | { success: true; tag: TagType }
    | { success: false; error: 'duplicate' | 'invalid' | 'forbidden' };

/**
 * Update tag result
 */
export type UpdateTagResultType =
    | { success: true; tag: TagType }
    | {
          success: false;
          error: 'not_found' | 'duplicate' | 'invalid' | 'forbidden';
      };

/**
 * Delete tag result
 */
export type DeleteTagResultType =
    | { success: true }
 ...
 * Get tag result
 */
export type GetTagResultType =
    | { success: true; tag: TagType; documentCount: number }
    | { success: false; error: 'not_found' };

/**
 * List tags result
 */
export type ListTagsResultType =
    | { success: true; tags: TagListItemType[]; total: number }
    | { success: false; error: 'invalid' };

/**
 * Add tags to document result
 */
export type AddTagsToDocumentResultType =
    | {
          success: true;
...
/**
 * Remove tag from document result
 */
export type RemoveTagFromDocumentResultType =
    | { success: true }
    | {
          success: false;
          error:
...
/**
 * Get document tags result
 */
export type GetDocumentTagsResultType =
    | { success: true; tags: TagListItemType[] }
    | { success: false; error: 'document_not_found' | 'forbidden' };
